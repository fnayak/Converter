...
public class ConverterService {
	...
	public String digits(String temp) // TO RETURN SELECTED NUMBERS IN WORDS
	{
		String converted = "";
	...
	public String numToString(int x) // CONVERT THE NUMBER TO STRING
	{
		String num = "";
		while (x != 0) {
	...
	public int inputNumber(int num) {
		...
		try {
			...
			System.out.println("Number should be Less than 999999999");
			System.exit(1);
		}
		return num;
	}
